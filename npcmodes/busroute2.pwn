...
StartPlayback()
{
	...
	{
	    case 0: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route21");
	    case 1: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route22");
	    case 2: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route23");
	    case 3: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route24");
	    case 4: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route25");
	    case 5: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route26");
	    case 6: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route27");
	    case 7: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route28");
	    case 8: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route29");
	    case 9: StartRecordingPlayback(PLAYER_RECORDING_TYPE_DRIVER,"route210");
	}
	gPlaybackFileCycle++;
	gStoppedForTraffic = 0;
}
